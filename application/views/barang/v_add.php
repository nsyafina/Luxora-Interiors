            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input name="material" class="form-control" placeholder="Material Barang ..." value="<?= set_value('material') ?>">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Warna</label>
                        <input name="warna" class="form-control" placeholder="Warna Barang ..." value="<?= set_value('warna') ?>">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Kapasitas</label>
                        <input name="kapasitas" class="form-control" placeholder="Kapasitas Barang ..." value="<?= set_value('kapasitas') ?>">
                    </div>
                </div>
            </div>
            <div class="row">
