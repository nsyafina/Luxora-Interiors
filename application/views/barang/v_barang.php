                ...
                <tbody>
                    ...
                    foreach ($barang as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center"><img src="<?= base_url('img/kategori/' . $value->gambar) ?>" width="150px"></td>
                            <td class="text-center">
                                <a href="<?= base_url('barang/edit/' . $value->id_barang) ?>" class="btn btn-warning btn-sm mb-1"><i class="fa fa-edit"></i></a><br>
